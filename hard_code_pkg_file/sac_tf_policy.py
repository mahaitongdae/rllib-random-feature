...
from ray.rllib.algorithms.sac.sac_torch_model import SACTorchModel, SACTorchRFModel
...
def build_sac_model(
    ...
    default_model_cls = SACTorchModel if config["framework"] == "torch" else SACTFModel # SACTorchRFModel, SACTorchModel
...
def build_rfsac_model(
    ...
    default_model_cls = SACTorchRFModel if config["framework"] == "torch" else SACTFModel # SACTorchRFModel, SACTorchModel
